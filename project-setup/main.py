...
def main():
    ...
    save_corr_map(data, 'heat-map.png')
    ...
    mlflow.log_artifact('heat-map.png')
    ...
    evaluate_model(test, 'baseline_dummy_model', base_line_artifact_uri, base_line_artifacts, lr_artifact_uri, lr_artifacts, 'lr_sklearn_model', lr_artifact_uri, signature, input_example, ['main.py'])
    ...
    evaluate_model(test, 'baseline_dummy_model', base_line_artifact_uri, base_line_artifacts, dtr_artifact_uri, dtr_artifacts, 'dtr_sklearn_model', dtr_artifact_uri, signature, input_example, ['main.py'])
